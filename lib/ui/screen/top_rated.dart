...
import 'package:goldenmovie/bloc/top_rated_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          Expanded(
            child: StreamBuilder<TopRatedState>(
              stream: topRatedBloc.topRatesState,
              builder: (context, snapshot) {
                TopRatedState? state = snapshot.data;
                    ...
                    return index == (state.data?.results?.length)! - 1
                        ? Align(
                            ...
                            child: StreamBuilder<bool>(
                                stream: topRatedBloc.loadingMore,
                                builder: (context, snapshot) {
